...
const OurServices = () => {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black">
      ...
      {/* Hero Section */}
      <section className="relative w-full overflow-hidden bg-black pt-40 pb-12 md:pb-16 lg:pb-24">
        <div className="relative container mx-auto px-4 md:px-6 z-10">
          <div className="mx-auto max-w-[1960px]">
            <div className="mb-12 md:mb-12 text-center">
              ...
              ></div>
              <p className="mt-2 max-w-3xl mx-auto text-lg md:text-xl lg:text-2xl leading-relaxed text-white/90">
                Psychology-led tools and insights that help organisations unlock
                hidden potential, understand neurodiversity, and navigate
      ...
      <section className="relative w-full overflow-hidden bg-black py-2 md:py-10 lg:py-0 mb-12">
        <div className="relative container mx-auto px-4 md:px-6 z-10">
          <div className="mx-auto max-w-[1960px]">
            {/* Five Cards Grid */}
