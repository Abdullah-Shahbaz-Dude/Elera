...
export const MIND_SYNC_MODULE_01: MindSyncModule = {
  ...
  learn: {
    heading: 'Part 2 – Learn (Text on screen)',
    body:
      "Now that you've watched the video, let's go a little deeper. This part of the module gives you the underlying technique you'll be practising in the scenarios that follow.\n\nWhy two ADHD brains may clash\nIn a typical parent-child conflict, there's usually a small emotional gap between what the child does and how the parent responds. The parent has a moment to think, choose, and reply. In ADHD-on-ADHD situations it is even harder to imagine\nADHD brains process emotional cues tone of voice, body language, facial expressions, much faster than they process the words people say. When your child speaks to you in way you feel is disrespectful or rude, your nervous system can react before the words have fully landed. You're not choosing to react. You're already reacting.\n\nThis is the part most parenting advice misses. \"Stay calm\" isn't a useful instruction when your nervous system is already three steps ahead of your thinking brain.",
    techniqueHeading: 'The technique: Catch the Rise',
    steps: [
      {
        title: 'Notice the body before the words',
        body:
          "Your body always knows before your mouth does. The signs are small but specific to you. Common ones: jaw tightens, shoulders lift, breath gets shallow, hands tense, a feeling of heat in the chest. Your job isn't to stop these signs from happening. Your job is to notice them happening even one of them before you speak.",
      },
      {
        title: 'Buy three seconds',
        body:
          "When you notice the rise, do anything that takes three seconds and puts something between you and the next sentence. The most reliable options: take one slow breath, count silently from three to one, place an object you're holding deliberately on a surface, take a half-step backwards. The point isn't relaxation. The point is interruption.",
      },
      {
        title: 'Speak from the calmer body',
        body:
          "After the three-second pause, your nervous system has dropped just enough for your thinking brain to come back online. Speak shorter, lower, slower. You don't have to say something brilliant. \"I need a moment\" is enough. \"Let's come back to this in five\" is enough. Walking out of the room saying nothing is enough.",
      },
    ],
    honestPart:
