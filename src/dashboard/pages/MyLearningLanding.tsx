    ...
    <div className="flex flex-col h-full overflow-hidden">
      <header className="h-20 flex items-center justify-between px-8 z-20 border-b border-white/5 glass-nav shrink-0">
        <div className="flex items-center gap-8">
          ...
          <div className="text-xs text-slate-400">Choose a training stream</div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl">
          {STREAMS.map((s) => (
            <div
              ...
              className="group relative aspect-[16/9] rounded-3xl overflow-hidden dashboard-card border border-white/10 hover:border-primary/50 transition-all duration-500 shadow-2xl bg-card-dark cursor-pointer"
            >
              <img
                alt={s.title}
                src={s.image}
              ...
              />
              <div className="absolute inset-0 module-card-overlay opacity-80" />
